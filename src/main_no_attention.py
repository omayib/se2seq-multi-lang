...
from src.config import BATCH_SIZE, NUM_EPOCHS, LEARNING_RATE, HIDDEN_SIZE, device, DROPOUT_RATE, MAX_LENGTH, \
    TRAINING_RATE, OUTPUT_DIR, RESULT_DIR, NUM_LAYER, NORMAL_CHECKPOINT
...
if __name__ == "__main__":
    ...
    decoder_multi_lang = DecoderRNN(hidden_size=HIDDEN_SIZE,
    ...
    torch.save({
        ...
        "decoder_state_dict": decoder_multi_lang.state_dict(),
    ...
    main_title = f"No Attention Training Results (Epochs: {NUM_EPOCHS}, Dropout: {DROPOUT_RATE:.2f}, LR: {LEARNING_RATE}, HS:{HIDDEN_SIZE}, L:{NUM_LAYER})"
